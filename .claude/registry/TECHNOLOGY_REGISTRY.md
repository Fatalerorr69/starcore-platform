...
| Prometheus | latest | Metriky | Aktivní |
| Loguru | 0.7+ | Logging | Aktivní |
| OpenTelemetry | 1.27+ | Tracing | Aktivní |
| uv | latest | Package manager | Aktivní |
| pytest | 8.4+ | Testy | Aktivní |
| hypothesis | 6.135+ | Property testy | Aktivní |
| ruff | 0.12+ | Linting | Aktivní |
| pyright | 1.1.390+ | Type checking | Aktivní |
| Bandit | - | SAST | Aktivní |
| gitleaks | - | Secret scan | Aktivní |
| MkDocs Material | 9.6+ | Dokumentace | Aktivní |
| Node.js | 22.22.2 | (pomocný) | Dostupný |
| Ansible | - | Infra automation | Plánováno |
| GitHub Actions | - | CI/CD | Aktivní |
| n8n | - | Workflow automation | Plánováno |
